...
- [Modern C++ 类和对象](#modern-c-类和对象)
  - [构造函数](#构造函数)
    - [显式默认的默认构造函数](#显式默认的默认构造函数)
    - [显式弃置的默认构造函数](#显式弃置的默认构造函数)
    - [显示默认或显示弃置的拷贝构造函数](#显示默认或显示弃置的拷贝构造函数)
    - [转换构造函数](#转换构造函数)
  - [赋值和移动](#赋值和移动)
    - [异常安全的赋值运算](#异常安全的赋值运算)
    - [移动语义](#移动语义)
  ...
  - [不同的数据成员类型](#不同的数据成员类型)
    - [`static` 数据成员](#static-数据成员)
      - [内联变量](#内联变量)
    - [`const static` 数据成员](#const-static-数据成员)
    - [引用数据成员](#引用数据成员)
  - [嵌套类](#嵌套类)
  - [运算符重载](#运算符重载)
    - [使用全局函数重载可交换的运算符](#使用全局函数重载可交换的运算符)
    - [重载比较运算符](#重载比较运算符)
