...
- [Chapter3. Modern C++ `std::format`](#chapter3-modern-c-stdformat)
  - [3.1 使用 `std::format()`](#31-使用-stdformat)
  - [3.2 格式说明符](#32-格式说明符)
    - [1. width](#1-width)
    ...
    - [7. `0`](#7-0)
  - [3.3 格式说明符错误](#33-格式说明符错误)
  - [3.4 支持自定义类型](#34-支持自定义类型)
